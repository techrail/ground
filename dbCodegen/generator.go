...
type CodegenConfig struct {
	...
	InsertCreatedAtInCode bool   // Should the code for `created_at` timestamp column be generated by the code generator?
	InsertUpdatedAtInCode bool   // Should the code for `updated_at` timestamp column be generated by the code generator?
}
